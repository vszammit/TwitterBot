...
public class MarkovChain implements Iterator<String> {
    ...
    void addBigram(String first, String second) {
        ...
        if (chain.containsKey(first)) {
            ...
            ProbabilityDistribution<String> temp2 = new ProbabilityDistribution<String>();
            temp2.record(second);
            chain.put(first, temp2);
        }
    ...
    public String next() {
        ...
        if (!hasNext()) {
            ...
            ProbabilityDistribution<String> currentDistribution = chain.get(current);
            if (currentDistribution == null) {
                newWord = null;
            } else {
                newWord = currentDistribution.pick(ng);
            }
        }
        return current;
    }
